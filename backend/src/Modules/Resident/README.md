...
```
Resident/
├── Domain/Alilu.Modules.Resident.Domain.csproj                  # Entidades, Value Objects, regras de negócio
├── Application/Alilu.Modules.Resident.Application.csproj        # Casos de uso, DTOs, orquestração
└── Infrastructure/Alilu.Modules.Resident.Infrastructure.csproj  # EF Core (IEntityTypeConfiguration), repositórios, integrações
```
