...
```
Identity/
├── Alilu.Modules.Identity.Domain/          # Entidades, Value Objects, regras de negócio
├── Alilu.Modules.Identity.Application/     # Casos de uso, DTOs, orquestração
└── Alilu.Modules.Identity.Infrastructure/  # EF Core (IEntityTypeConfiguration), repositórios, integrações
```
